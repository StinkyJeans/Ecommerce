      ...
      <main className="flex-1 ml-64 overflow-auto">
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Update your profile, security preferences, and addresses.</p>
          </div>
          ...
          {authLoading || loading ? (
            ...
            <div className="space-y-8">
              ...
              {/* Address Book */}
              <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Address Book</h2>
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              <span className="text-lg font-bold text-gray-900 dark:text-gray-100">Totally Normal Store</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400">© {new Date().getFullYear()} Totally Normal Store. All rights reserved.</p>
          </footer>
        </div>
      </main>
    </div>
