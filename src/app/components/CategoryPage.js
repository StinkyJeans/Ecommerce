...
export default function CategoryPage({ categoryName, categoryValue }) {
  ...
  return (
    <>
        ...
        <div className="px-8 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <button type="button" className="text-[#2C2C2C] dark:text-[#e5e5e5] hover:text-[#FFBF00] transition-colors">
                New Arrivals
              </button>
              <button type="button" className="text-[#2C2C2C] dark:text-[#e5e5e5] hover:text-[#FFBF00] transition-colors">
                Best Sellers
      ...
      <div className="p-8">
        <nav className="mb-4 text-sm text-[#666666] dark:text-[#a3a3a3] flex items-center flex-wrap gap-x-1">
