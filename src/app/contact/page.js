        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 mb-10 sm:mb-12">
          ...
          <div className="space-y-5 sm:space-y-6">
            <div className="bg-white dark:bg-[#2C2C2C] rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-[#E0E0E0] dark:border-[#404040] space-y-4">
              <div>
                <h2 className="text-sm font-semibold text-[#FFBF00] uppercase tracking-wide mb-2">
                  Email Us
                </h2>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 text-sm font-semibold text-[#FFBF00] hover:text-[#e6ac00]"
                >
            ...
            <div className="bg-white dark:bg-[#2C2C2C] rounded-xl sm:rounded-2xl overflow-hidden shadow-sm border border-[#E0E0E0] dark:border-[#404040]">
              <div className="aspect-video bg-[url('/images/contact-map-placeholder.png')] bg-cover bg-center relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#FFBF00] shadow-lg flex items-center justify-center">
                    <FontAwesomeIcon
                      icon={faLocationDot}
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-[#E0E0E0] dark:border-[#404040] bg-white dark:bg-[#1f1f1f] px-3 py-2.5 text-sm text-[#2C2C2C] dark:text-[#e5e5e5] focus:outline-none focus:ring-2 focus:ring-[#FFBF00]"
                    />
                  </div>
                  <div>
                    <label className="block text-xs sm:text-sm font-semibold text-[#2C2C2C] dark:text-[#e5e5e5] mb-1.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-[#E0E0E0] dark:border-[#404040] bg-white dark:bg-[#1f1f1f] px-3 py-2.5 text-sm text-[#2C2C2C] dark:text-[#e5e5e5] resize-none focus:outline-none focus:ring-2 focus:ring-[#FFBF00]"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-[#FFBF00] hover:bg-[#e6ac00] text-[#2C2C2C] font-semibold text-sm sm:text-base px-6 sm:px-8 py-2.5 sm:py-3 shadow-md hover:shadow-lg transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {submitting ? (
                    <span>Sending...</span>
                  ) : (
                ...
                <p className="text-[11px] sm:text-xs text-[#777777] dark:text-[#a3a3a3] mt-1">
                  ...
                  <button
                    ...
                    className="text-[#FFBF00] hover:text-[#e6ac00] font-medium"
                  >
                    Terms of Service
                  </button>{" "}
                  and{" "}
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <div className="flex items-start gap-3 mb-2">
                  <div className="w-8 h-8 rounded-full bg-[#FFBF00]/15 flex items-center justify-center">
                    <FontAwesomeIcon
                      icon={faQuestionCircle}
                      className="text-[#FFBF00] text-sm"
                    />
                  </div>
